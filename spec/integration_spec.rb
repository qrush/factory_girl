...
describe "integration" do
  before do
    ...
    Factory.define :guest, :parent => :user do |f|
      ...
      f.email {|a| "#{a.first_name}.#{a.last_name}@example.com".upcase }
    end

    Factory.define :duplicate_attributes, :parent => :user do |f|
      f.last_name "Anonymous"
      f.last_name "Coward"
    end
  ...
  describe "an instance generated by a factory that inherits from another factory" do
    ...
    it "should have attributes calculated in a block based on its parent" do
      @instance.email.should == "JIMI.ANONYMOUS@EXAMPLE.COM"
    end
  end
  ...
  describe "a factory with duplicate attributes defined" do
    it "should use the attribute called last for assignment" do
      Factory(:duplicate_attributes).last_name.should == "Coward"
    end

    it "should allow duplicate defined attributes to be overridden" do
      Factory(:duplicate_attributes, :last_name => "Doe").last_name.should == "Doe"
    end
  end
